...
SYSTEM_PROMPT = """You are a helpful assistant. Before calling any tool, think through what information you need and why. Then call the appropriate tool to get that information."""
