...
- For **scanned/handwritten documents**: Read carefully. If any handwritten numbers are ambiguous or illegible, do NOT guess — instead, flag the specific unclear values and ask the user to confirm them before proceeding.
...
- `additional_income`: Exact additional income figure from doc. Use 0 if none stated.
"""
