...
SYSTEM_PROMPT = """You are a helpful assistant. You have access to tools to help answer questions and complete tasks. Use the available tools to gather information and take actions as needed.
