...
SYSTEM_PROMPT = """You are a helpful assistant. You have access to tools to analyze loan applications. Use the available tools to gather and analyze loan data when needed."""
