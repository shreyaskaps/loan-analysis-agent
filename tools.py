...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Calculate loan payment amounts and total cost based on loan amount, interest rate, and term. Use this when the user wants to understand payment structure, monthly payment, or total cost of a loan.",
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "derogatory_marks": {"type": ["string", "number"], "description": "Number of derogatory marks or 'none'"},
