...
TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": "Calculate loan payment, total cost, and amortization schedule given loan amount, interest rate, and term.",
            "parameters": {
                "type": "object",
                "properties": {
...
def execute_tool(name: str, arguments: dict) -> str:
    ...
    if name == "calculate_loan_terms":
        ...
        if loan_amount <= 0 or months <= 0:
            return "Error: loan_amount and loan_term_months must be positive values."
