...
TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": "Calculate loan payments, total cost, and amortization details based on loan amount, interest rate, and term. Use this when the user provides loan parameters and wants payment information.",
            "parameters": {
                "type": "object",
                "properties": {
...
def execute_tool(name: str, arguments: dict) -> str:
    ...
    if name == "calculate_loan_terms":
        ...
        months = arguments.get("loan_term_months", 0)
        
        if loan_amount <= 0 or months <= 0:
            return "Error: loan_amount and loan_term_months must be greater than 0."
        
        # Calculate monthly payment using standard formula: M = P * [r(1+r)^n] / [(1+r)^n - 1]
        ...
        return (
            ...
            f"Annual interest rate: {annual_rate}%. Loan term: {months} months. "
